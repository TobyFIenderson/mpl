...
def test_add(opnd1_file_path, opnd2_file_path, in_result_file_path, out_result_file_path):
    opnd1 = get_mpi_from_file(opnd1_file_path)
    opnd2 = get_mpi_from_file(opnd2_file_path)
    presult = []
    for i in range(len(opnd1)):
        presult.append(opnd1[i] + opnd2[i])
...
test_add("mpl/mpi_test/add_test_operand_1", "mpl/mpi_test/add_test_operand_2", "mpl/mpi_test/add_test_result", "mpl/mpi_test/add_test_py_result")