...
def test_sub(opnd1_file_path, opnd2_file_path, in_result_file_path, out_result_file_path):
...
test_sub("mpi_test/sub_test_operand_1", "mpi_test/sub_test_operand_2", "mpi_test/sub_test_result", "mpi_test/sub_test_py_result")